...
class NamespaceManager(W.VBox):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.children = tuple(
            [self.default_namespaces, self.user_namespaces]
        )
    ...
    def make_default_namespaces(self):
        default_namespaces = W.HTML(
            """
            <p style="color:blue;font-size:12px;">PREFIX xsd: <i>&#60;http://www.w3.org/2001/XMLSchema#&#62;</i></p>
            <p style="color:blue;font-size:12px;">PREFIX rdfs: <i>&#60;http://www.w3.org/2000/01/rdf-schema#&#62;</i></p>
            <p style="color:blue;font-size:12px;">PREFIX rdf: <i>&#60;http://www.w3.org/1999/02/22-rdf-syntax-ns#&#62;</i></p>
            """
        )
    ...
    def update_namespaces(self, changes):
        self.namespaces = "\n".join(
            [
                self.included_namespaces_value,
                changes.new,
            ]
        )
